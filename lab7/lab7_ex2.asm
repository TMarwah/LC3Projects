...
;Q1. Also results in an infinite loop

;Q2. R0 contains a 0 while R1 contains a 5
 
;Q3. R0 contains a 0 while R1 contains a 4  
;    
;Q4. R7 contains the value x3207

;Q5. The program will keep looping, as R1 is initialized, R2 contains the value of R0
;    and the multiply subroutine is invoked. R7 always refers back to x3207

;R7 gets the SUB_MULT, returns to FACT, contains x3207 and infinitely loops